...
class BankReplTest {
    ...
    void balance_whenLoggedIn_printsFormattedBalance() {
        ...
        when(mockUserService.login("acc-123", "1234")).thenReturn(true);
        when(mockUserService.checkBalance("acc-123", "1234")).thenReturn(250.5);
        ...
        BankRepl repl = new BankRepl(mockUserService, mockTransactionService);
        repl.run();
